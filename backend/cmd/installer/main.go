...
import (
	...
	"pentagentx/cmd/installer/hardening"
	"pentagentx/cmd/installer/state"
	"pentagentx/cmd/installer/wizard"
...
func parseFlags(args []string) Config {
	...
	flagSet.Usage = func() {
		fmt.Fprintf(os.Stderr, "PentAgentX Installer v%s\n\n", version.GetBinaryVersion())
...
func createInitialEnvFile(path string) error {
	...
	content = fmt.Appendf(nil, `# PentAgentX Environment Configuration
# Generated by PentAgentX Installer v%s
#
# This file contains environment variables for PentAgentX configuration.
...
func printStartupInfo(envPath string, checkResult checker.CheckResult) {
	fmt.Printf("PentAgentX Installer v%s\n", version.GetBinaryVersion())
